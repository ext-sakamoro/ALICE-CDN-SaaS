...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['10 GB bandwidth/mo', '3 edge regions', 'Basic caching', 'Community support'] },
  { name: 'Pro', price: '$99/mo', features: ['1 TB bandwidth/mo', 'All global regions', 'Vivaldi latency optimization', 'Custom cache rules', '20,000 API calls/hr', 'Priority support'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited bandwidth', 'Private edge nodes', 'Real-time purge', 'Custom SSL', 'SLA 99.99%', 'Dedicated support'] },
];
